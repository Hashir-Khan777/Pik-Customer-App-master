...
const HomePackageLocationSearchScreen = ({
  navigation,
  route,
  recentAddresses,
  savedAddresses,
  ...
  let {setSelectedAddress, setSelectedAddressName} = route.params;
  ...
  const requestGeocoding = () => {
    timeout = null;
    if (searchRequest) searchRequest.reject();
  ...
  return (
    <KeyboardAvoidingScreen>
      <PageContainerDark Header={<HeaderPage title="Select Location" />}>
        <View style={globalStyles.inputWrapper}>
          <View style={globalStyles.flexRowCenter}>
            ...
            />
            <Text style={styles.cancelBtn} onPress={cancelSearch}>
              Cancel
            </Text>
          </View>
        </View>
        ...
        {!!searchText ? (
          ...
          <View>
            ...
            {recentAddresses.map((adr, index) => (
              <AddressItem
                onPress={() => selectAddress(adr)}
                key={index}
                item={adr}
              />
            ))}
        ...
        <ProgressModal title="Please wait ..." visible={inProgress} />
      </PageContainerDark>
    </KeyboardAvoidingScreen>
  );
};
