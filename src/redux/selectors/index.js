...
const getAvailables = createSelector([getOrders, getUser], (orders, user) => {
...
const getOrdersGroupedByDate = createSelector([getOrders], (orders) => {
  let days = {};
...
const getFeedbackList = createSelector(
  ...
  (orders, authUser) => {
    return orders.filter((o) => {
      if (o.status !== OrderStatuses.Delivered) return false;
...
export {getAvailables, getOrdersGroupedByDate, getFeedbackList};
